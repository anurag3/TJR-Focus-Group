    ...
    public void buttonselection4(View view) {
        ...
        switch (id) {
            case R.id.bodybtn1:
                ...
                entry = DataEntry.startEntry(4, "VerticalScroll", Joint.BACK);
                arr.set(0, 1);
                verticalscroll(B1);
                break;
            case R.id.bodybtn2:
                //udc.writeToSDFile("Right Hip Survery Started");
                entry = DataEntry.startEntry(4, "VerticalScroll", Joint.LEFT_HIP);
                arr.set(1, 1);
                verticalscroll(B2);
                break;
            case R.id.bodybtn3:
                //udc.writeToSDFile("Left Hip Survery Started");
                entry = DataEntry.startEntry(4, "VerticalScroll", Joint.RIGHT_HIP);
                arr.set(2, 1);
                verticalscroll(B3);
                break;
            case R.id.bodybtn4:
                //udc.writeToSDFile("Right Knee Survey Started");
                entry = DataEntry.startEntry(4, "VerticalScroll", Joint.LEFT_KNEE);
                arr.set(3, 1);
                verticalscroll(B4);
                break;
            case R.id.bodybtn5:
                //udc.writeToSDFile("Left Knee Survey Started");
                entry = DataEntry.startEntry(4, "VerticalScroll", Joint.RIGHT_KNEE);
                arr.set(4, 1);
                verticalscroll(B5);
                break;

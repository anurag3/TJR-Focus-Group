    ...
    public void buttonselection3(View view) {
        ...
        switch (id) {
            case R.id.bodybtn1:
                ...
                entry = DataEntry.startEntry(3, "HorizontalScroll", Joint.BACK);
                arr.set(0, 1);
                horizontalscroll(B1);
                break;
            case R.id.bodybtn2:
                //udc.writeToSDFile("Right Hip Survery Started");
                entry = DataEntry.startEntry(3, "HorizontalScroll", Joint.LEFT_HIP);
                arr.set(1, 1);
                horizontalscroll(B2);
                break;
            case R.id.bodybtn3:
                //udc.writeToSDFile("Left Hip Survery Started");
                entry = DataEntry.startEntry(3, "HorizontalScroll", Joint.RIGHT_HIP);
                arr.set(2, 1);
                horizontalscroll(B3);
                break;
            case R.id.bodybtn4:
                //udc.writeToSDFile("Right Knee Survey Started");
                entry = DataEntry.startEntry(3, "HorizontalScroll", Joint.LEFT_KNEE);
                arr.set(3, 1);
                horizontalscroll(B4);
                break;
            case R.id.bodybtn5:
                //udc.writeToSDFile("Left Knee Survey Started");
                entry = DataEntry.startEntry(3, "HorizontalScroll", Joint.RIGHT_KNEE);
                arr.set(4, 1);
                horizontalscroll(B5);
                break;
